...
class ValidadorCPFTestCase(TestCase):
    ...
    def test_validar_num_iguais(self):
        cpf = '11111111111'

        validador = ValidadorCPF(cpf)
        self.assertTrue(validador.validar_num_iguais())

    def test_validar_num_diferentes(self):
        cpf = '35830284308'

        validador = ValidadorCPF(cpf)
        self.assertFalse(validador.validar_num_iguais())
